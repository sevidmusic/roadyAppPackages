...
rig --new-request --for-app 'HelloWorld' --name 'HelloWorld0' --relative-url 'index.php' --container 'HelloWorldRequests'

rig --new-request --for-app 'HelloWorld' --name 'HelloWorld1' --relative-url '' --container 'HelloWorldRequests'
...
rig --assign-to-response --for-app 'HelloWorld' --response 'HelloWorld' --requests 'HelloWorld1' 
